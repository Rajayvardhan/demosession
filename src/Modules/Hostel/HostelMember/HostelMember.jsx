...
console.log("students", TransportData);
          ...
          <div className="card">
            <div className="card-header pb-0">
              <div className="d-flex">
                ...
                <h5 style={{marginLeft:"13px", marginTop:"13px"}}>All Hostel Members</h5>
                  ...
                  <div className="col-sm-4 drop pull-right drop-marg col-lg-2 col-md-2 col-xs-12">
                    <select className="select1" onChange={SelectClassHandler} style={{ padding: "8px 10px", borderRadius: "40px", marginLeft: "634px", marginTop: "9px", position: "relative", top: "-41px" }}>
  ...
  {u?.hostel === "0" && (
    <Link to={`/hostel/member/add/${u.studentID}/${u.classesID}`} state={{ HostelAddData: u}}>
      <i className="fa fa-plus"></i> 
    </Link>
  )}
  {u?.hostel === "1" && (
  <Link to={`/member/edit/${u.studentID}/${u.classesID}`} state={{ tmemberData: u, studentName: u.name }}>
    <i className="fa fa-edit edit"></i>
  </Link>
  )}
  {u?.hostel === "1" && (
  <Link to={`/member/view/${u.studentID}/${u.classesID}`} state=
