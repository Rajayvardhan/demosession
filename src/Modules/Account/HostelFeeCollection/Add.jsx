  ...
  const saveData = async (e) => {
    ...
    try {
      ...
      if (response.status === "200") {
        ...
        var urll = `${BaseURL}/buscollection/printPreview/${schoolyearID}/${cID}`;
                            ...
                            <div className="row">
                              ...
                              <span className="col-sm-2 control-label">
                                {tmember && tmember.transportID ? (
                                  <Link
                                    to={`/transport/member/edit/${tmember.studentID}/${tmember.classesID}`}
                                    state={{
                                      tmemberData: tmember,
                                      studentName: selectedStudentName,
                                    }}
                                  ...
                                  <Link
                                    to={`/transport/member/add/${studentData.studentID}/${studentData.classesID}`}
                                    state={{ transportAddData: studentData }}
                                  >
